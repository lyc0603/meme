...
def _fetch_events_for_all_contracts(
    ...
    if from_block is None:
        raise ValueError("Missing mandatory keyword argument to get_logs: from_block")
...
if __name__ == "__main__":
    ...
    RCC_ADDRESS = Web3.to_checksum_address("0x9b6443b0fb9c241a7fdac375595cea13e6b7807a")
