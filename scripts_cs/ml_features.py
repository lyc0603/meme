...
from environ.utils import handle_first_comment_bot, handle_first_wash_bot
    ...
    for (token_add, chain), group in grouped:
        ...
        if wash_rows:
            try:
                ...
                print(f"Could not parse wash bot time for {token_add} on {chain}")
                wash_first_time = None
        ...
        if comment_rows:
            try:
                ...
                print(f"Could not parse comment bot time for {token_add} on {chain}")
                comment_first_time = None
